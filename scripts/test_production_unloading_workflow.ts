  ...
  try {
    ...
    const visit = await prisma.vehicleVisit.create({
      data: {
        ...
        portions: {
          create: [
            { portion_number: 1, dispatch_quantity_value: 8000, plant_decision: 'ACCEPTED', current_status: 'PLANT_QA' },
            { portion_number: 2, dispatch_quantity_value: 5000, plant_decision: 'REJECTED', plant_rejection_reason: 'High acidity', current_status: 'PLANT_QA' },
          ],
        },
        weight_ticket: {
          create: {
