  ...
  try {
    ...
    const visitNorm = await prisma.vehicleVisit.create({
      data: {
        ...
        portions: {
          create: [
            { portion_number: 1, declared_quantity_value: 10000, plant_decision: 'ACCEPTED', current_status: 'DISPATCHED' },
          ],
        },
      },
    ...
    const visitPending = await prisma.vehicleVisit.create({
      data: {
        ...
        created_by: secUser.id,
        portions: {
          create: [{ portion_number: 1, declared_quantity_value: 5000, plant_decision: 'ACCEPTED', current_status: 'UNLOADED' }],
        },
        gate_log: {
    ...
    const visitReject = await prisma.vehicleVisit.create({
      data: {
        ...
        portions: {
          create: [
            { portion_number: 1, declared_quantity_value: 6000, plant_decision: 'REJECTED', current_status: 'PLANT_QA' },
            { portion_number: 2, declared_quantity_value: 4000, plant_decision: 'REJECTED', current_status: 'PLANT_QA' },
          ],
        },
        gate_log: {
