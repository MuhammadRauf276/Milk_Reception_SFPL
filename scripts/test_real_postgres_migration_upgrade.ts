...
async function runRealPostgresMigrationUpgradeTest() {
  ...
  try {
    ...
    // Migration count check (33 tracked migrations)
    ...
    assert(
      migrationDirs.length === 33,
      'MIG-COUNT-1: Repository contains exactly 33 tracked migrations',
    ...
    assert(
      migrationDirs.includes('20260920000000_stage_6g_g_paper_identities_and_concurrency'),
      'MIG-STAGE6GG-32: 20260920000000_stage_6g_g_paper_identities_and_concurrency migration is present'
    );
    assert(
      migrationDirs.includes('20260920120000_stage_6g_g_correction_governance_and_counters'),
      'MIG-STAGE6GG-33: 20260920120000_stage_6g_g_correction_governance_and_counters migration is present'
    );
